...
* **Serial Mode Execution** - In Serial Mode, tests run one after another, without parallel execution.
...
```
  ...
  * To run tests in serial within a file: This ensures all tests in that describe block run parallelly.
